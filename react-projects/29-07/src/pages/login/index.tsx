...
const formSchema = z.object({
    user_email: z.string().email({ message: 'The invalid email address' }).min(1, 'The email field is required.'),
...
const [formData, setFormData] = useState<FormData>({ user_email: '', password: '' });
  ...
  if (!result.success) {
    ...
    setIsLoading(true);
      try {
        ...
        const encryptedUser = encryptData(JSON.stringify(response.data.data));
              ...
              <Row>
                  ...
                  <Col md={6}>
                      <div className={styles.formRightBlog}>
                          ...
                          <h5 className='fontRegular'>Please enter your email and password to continue.</h5>
                          <Form onSubmit={handleSubmit}>
                              <Form.Group className={`mb-25 position-relative PrefixElement ${errors.user_email?'input_error':''}`}>
                                  <Form.Label>Email</Form.Label>
                                  <Form.Control type="text" placeholder="Your Email address" name="user_email" value={formData.user_email}  onChange={handleChange} autoComplete="false" />
                              ...
                              <Form.Group className={`position-relative PrefixElement ${errors.password?'input_error':''}`}>
                              ...
                              <Form.Group className="text-end">
                                  <Link href="/forgot-password" className={styles.fogotarea}>Forgot password ?</Link>
                              </Form.Group>
